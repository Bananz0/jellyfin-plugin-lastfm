...
- **Repo name:** Last.fm (un)Stable - for personal use until mainline fixes the issue  
- **Repo URL:** https://raw.githubusercontent.com/bananz0/jellyfin-plugin-lastfm/refs/heads/master/manifest.json
